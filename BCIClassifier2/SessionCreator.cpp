 ...
 */
const QString clientId = "com.pablos.bciclassifier2";
const QString clientSecret = "3DwcZxTBORSTKRq20mllLYDTBibXR2Q45jI3GjWH";
...
SessionCreator::SessionCreator(QString userId,QString userPass,QObject *parent) : QObject(parent) {
    client = nullptr;
    username = userId;
    password = userPass;
